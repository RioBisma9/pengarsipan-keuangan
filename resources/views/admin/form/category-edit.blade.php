            ...
            <div class="bg-white shadow-md sm:rounded-xl p-8 border border-gray-200">
                <form action="{{ route('category.update', $category->id) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="deskripsi" id="keterangan" value="{{ $category->deskripsi }}"
                            class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm"
                        ...
                        @foreach ($categories as $categori)
                            <div
                                ...
                                <div class="flex gap-2">
                                    <a href="#" class="p-2 bg-blue-500 hover:bg-blue-600 text-white rounded-md">
                                        <img src="https://img.icons8.com/?size=24&id=88584&format=png&color=ffffff"
                                            alt="edit"></a>
                                    <a href="#" class="p-2 bg-red-500 hover:bg-red-600 text-white rounded-md">
